            ...
            <div className="relative z-10 max-w-[900px] mx-auto text-center">
                ...
                >
                    ...
                    <div className="relative flex justify-center items-center w-[min(90vw,440px)] h-[min(90vw,440px)] sm:w-[440px] sm:h-[440px]">
                        ...
                        {/* Mobile Optimized: Static Glow instead of heavy particles */}
                        {isMobile ? (
                            <div className="absolute inset-0 flex items-center justify-center">
                                <div className="absolute w-[90%] h-[90%] bg-[var(--accent)]/10 blur-[80px] rounded-full" />
                                <div className="absolute w-[80%] h-[80%] bg-[var(--accent-2)]/10 blur-[60px] rounded-full" />
                        ...
                        >
                            <motion.img
                                ...
                                animate={isMobile ? {} : { rotate: [-1.5, 1.5, -1.5] }}
                    ...
                    {/* Glowing platform / pedestal base (Simplified on mobile) */}
